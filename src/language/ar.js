export const arabic = {
  ...
  "fund to get max of": "صندوق للحصول على الحد الأقصى من",
  ...
  "You got a free home delivery service":
    "حصلت على خدمة توصيل إلى المنازل المجانية",
  ...
  Distance: "مسافة",
  Other: "آخر",
  "Charge Paid By": "الرسوم المدفوعة بواسطة",
  ...
  "If you want to change store type, it will reset your cart and other related cache data.":
    "إذا كنت ترغب في تغيير نوع المتجر ، فسيقوم بإعادة ضبط عربة التسوق وبيانات ذاكرة التخزين المؤقت الأخرى ذات الصلة.",
  Change: "يتغير",
  Location: "موقع",
  ...
  "We provide best quality & fresh grocery items near your location":
    "نحن نقدم أفضل جودة وقالة جديدة بالقرب من موقعك",
  ...
  "This variation is out of stock": "هذا الاختلاف غير منفرج",
  "Free delivery": "توصيل مجاني",
  ...
  "Upload your prescriptions here and get your medicine right at your door step":
    "قم بتحميل الوصفات الطبية الخاصة بك هنا واحصل على الدواء الخاص بك مباشرة عند خطوة الباب الخاص بك",
  ...
  "We provide best quality & valuable products around the world":
    "نحن نقدم أفضل منتجات الجودة والقيمة في جميع أنحاء العالم",
